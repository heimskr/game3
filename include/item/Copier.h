...
namespace Game3 {
	...
	class Copier: public Item {
		public:
			...
			bool populateMenu(const ItemStackPtr &, Glib::RefPtr<Gio::Menu>, Glib::RefPtr<Gio::SimpleActionGroup>) const override;

			std::string getTiles(const ItemStackPtr &, const std::shared_ptr<Realm> &) const;
