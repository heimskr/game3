...
namespace Game3 {
	...
	struct Furniture: Item {
		...
		static std::shared_ptr<Furniture> create(ItemID id_, std::string name_, MoneyCount base_price, Layer, MarchableInfo);
	};
	...
	class MarchableFurniture: public Furniture {
		public:
			MarchableFurniture(ItemID, std::string name_, MoneyCount base_price, Layer, MarchableInfo);
