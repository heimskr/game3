...
macos_setup:
	- vcpkg install
	PKG_CONFIG_PATH=vcpkg_installed/arm64-osx/lib/pkgconfig meson setup -Dno_discord=true -Dvcpkg_triplet=arm64-osx builddir .

macos_reconf:
	PKG_CONFIG_PATH=vcpkg_installed/arm64-osx/lib/pkgconfig meson setup -Dno_discord=true -Dvcpkg_triplet=arm64-osx --reconfigure builddir .
