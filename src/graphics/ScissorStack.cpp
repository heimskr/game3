...
namespace Game3 {
	...
	const Rectangle & ScissorStack::pushRelative(const Rectangle &rect, bool do_viewport, bool do_scissor) {
	...
	const Rectangle & ScissorStack::pushAbsolute(const Rectangle &rect, bool do_viewport, bool do_scissor) {
