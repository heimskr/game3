...
// namespace Game3 {
// 	Canvas::Canvas(Window &window_): window(window_) {
// 		magic = 16 / 2;
// 		fbo.init();
// 	}
...
// 		uiContext.render(window.getMouseX(), window.getMouseY());
// 	}

// 	int Canvas::getWidth() const {
// 		return window.getWidth() / sizeDivisor;
// 	}

// 	int Canvas::getHeight() const {
// 		return window.getHeight() / sizeDivisor;
// 	}
...
// 		return {window.getMouseX(), window.getMouseY()};
// 	}
