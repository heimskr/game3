...
namespace Game3 {
	...
	std::unordered_set<TileID> HouseTiles::solidSet {
		WALL_NW, WALL_WEN, WALL_NE, WALL_NS, WALL_SW, WALL_WES, WALL_SE, WALL_E, WALL_W, BOOKSHELF, PLANT1, PLANT2, PLANT3, STOCKPILE_W, STOCKPILE_E, COUNTER, COUNTER_W, COUNTER_WE, COUNTER_E, ANVIL,
		FURNACE,
	};
